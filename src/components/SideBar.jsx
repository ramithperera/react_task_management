        ...
        <div>
            ...
            isSideBarOpen && (
              ...
              >
                ...
                >
                  ...
                  <div
                    className=' mx-2 mb-2 p-4 relative space-x-2 bg-slate-100 dark:bg-[#20212c]
...

          {
            isSideBarOpen ? (
              ...
              rounded-r-full hover:text-[#635fc7] cursor-pointer mr-6 mb-6 px-8 py-4
              hover:bg-[#635fc71a] dark:hover:bg-white space-x-2 justify-center
              my-4 text-gray-500'
              >
                <img src={hideSidebarIcon} className=' min-w-[20px]' alt="hide-icon" />
            ...
            >
              <img src={showSidebarIcon} alt="show-icon" />
