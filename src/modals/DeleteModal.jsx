...
function DeleteModal({ type, title, onDeleteBtnClick, setIsDeleteModalOpen }) {
  return (
    ...
    overflow-scroll scrollbar-hide z-50 justify-center items-center flex
    bg-[#00000080]"
      onClick={(e) => {
    ...
    >
      ...
      <div
        className=" scrollbar-hide overflow-y-scroll max-w-md max-h-[95vh] my-auto
      ...
      >
        ...
        {type === "task" ? (
          <p
            className=" text-gray-500 font-semibold tracking-wide text-sm
                pt-6"
          >
            Are you sure you want to delete the "{title}" task and it's
        ...
        <div className=" flex w-full mt-4 items-center justify-center space-x-4">
          <button
            ...
            className=" w-full items-center text-white hover:opacity-75
            font-semibold bg-red-500 py-2 rounded-full"
          >
            Delete
          </button>
          <button
            onClick={() => setIsDeleteModalOpen(false)}
            className=" w-full items-center text-[#635fc7] hover:opacity-75
            font-semibold bg-[#635fc71a] py-2 rounded-full"
          >
            Cancel
          </button>
        </div>
