...
function AddEditBoardModal({setBoardModalOpen, type}) {
  ...
  return (
    ...
    className='
     fixed right-0 left-0 top-0 bottom-0 px-2 scrollbar-hide py-4 overflow-scroll z-50
    ...
    >
        ...
        text-black dark:text-white font-bold shadow-md shadow-[#364e7e] max-w-md mx-auto
        ...
        >
            ...
            <div className=' mt-8 flex flex-col space-y-3'>
                ...
                <input className='
                 bg-transparent px-4 py2 rounded-md text-sm border border-gray-600
...

                {
                    newColumns.map((column, index) => (
                        <div key={index} className=' flex items-center w-full'>
                            ...
                            <img src={crossIcon} alt="plus-icon" 
            ...
            <div>
                ...
                <button
                className=' w-full items-center hover:opacity-75 dark:text-white dark:bg-[#635fc7]
                mt-8 relative text-white bg-[#635fc7] py-2 rounded-full'
                onClick={
                    () => {
                        const isValid = vallidate()
